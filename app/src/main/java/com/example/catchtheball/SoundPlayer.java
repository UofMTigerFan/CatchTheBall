...
public class SoundPlayer {
    ...
    public SoundPlayer(Context context) {
        ...
        hitOrangeSound = soundPool.load(context, R.raw.orangesound, 1);
        hitPinkSound = soundPool.load(context, R.raw.pinksound, 1);
        hitBlackSound = soundPool.load(context,R.raw.blacksound, 1);
    }
